...
【数据安全】应对用户个人信息进行保护；数据传输应采用加密通道；应定期备份数据。`,
    tags: ['等保三级', '基本要求', 'GB/T 22239', '核心业务系统'],
  },
  {
    id: 'djbh-002',
    category: '等级保护',
...
承载大量用户数据、交易数据或关键业务流程的信息系统，通常需要结合业务重要性、服务范围和受损影响定为二级或三级。
面向公众服务、影响重要业务连续性或涉及重要数据处理的核心业务系统，建议重点评估是否达到第三级定级条件。
内部办公、辅助管理等系统应结合受侵害客体和侵害程度进行独立定级，避免简单套用行业样例。`,
    tags: ['等保定级', 'GB/T 22240', '核心业务系统', '定级指南'],
  },
  {
    id: 'djbh-003',
    category: '等级保护',
